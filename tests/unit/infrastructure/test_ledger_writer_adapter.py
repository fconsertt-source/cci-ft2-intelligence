...
class TestHashChainedLedgerWriter:
    ...
    def test_append_is_atomic(self, ledger_writer):
        ...
        with open(ledger_writer.ledger_path, 'r') as f:
            lines = f.readlines()
    ...
    def test_state_persists_across_instances(self, temp_ledger_dir):
        ...
        writer1 = HashChainedLedgerWriter(ledger_path=ledger_path, state_path=state_path)
        ...
        writer2 = HashChainedLedgerWriter(ledger_path=ledger_path, state_path=state_path)
